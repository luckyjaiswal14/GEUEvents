...
import { Club, Membership, ClubEvent, PerformanceMetric, Attendance, MembershipRole } from '../types';
...
export default function ClubManagement() {
  ...
  const [activeTab, setActiveTab] = useState<'members' | 'events' | 'performance'>('members');
                    ...
                    {members.filter(m => m.status === 'pending').map(request => (
                      <div key={request.id} className="p-4 flex items-center justify-between bg-white/50">
                        ...
                        <div className="flex gap-2">
                          ...
                          <button className="bg-white text-slate-600 border border-slate-200 px-4 py-2 rounded-lg hover:bg-slate-50 transition-colors text-sm font-bold">
                            Reject
                          </button>
                        </div>
                      </div>
                        ...
                        <tr key={member.id} className="hover:bg-slate-50 transition-colors">
                          ...
                          <td className="px-6 py-4 text-right">
                            <button 
                              ...
                              className="text-blue-600 hover:text-blue-800 font-bold text-sm flex items-center gap-1 ml-auto"
                            >
          ...
          {activeTab === 'performance' && (
            ...
            >
              ...
              <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
                <button className="bg-blue-600 text-white px-8 py-3 rounded-xl hover:bg-blue-700 transition-colors font-bold shadow-lg">
                  Run Scoring Engine
                </button>
                <button className="bg-white text-slate-700 border border-slate-200 px-8 py-3 rounded-xl hover:bg-slate-50 transition-colors font-bold">
                  Export CSV Report
                </button>
              </div>
            </motion.div>
